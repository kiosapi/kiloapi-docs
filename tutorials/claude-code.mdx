---
title: Claude Code
description: Set up Anthropic's Claude Code CLI with KiloAPI to use Claude models in your terminal.
---

# Claude Code

[Claude Code](https://docs.anthropic.com/en/docs/claude-code) is Anthropic's official agentic coding tool that runs in your terminal. This guide shows you how to configure it to use KiloAPI as the backend provider.
...
This disables experimental beta headers that KiloAPI may not support.

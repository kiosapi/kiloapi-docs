---
title: OpenClaw
description: Configure OpenClaw CLI to use KiosAPI as the backend provider.
---

# OpenClaw

[OpenClaw](https://github.com/openclaw/openclaw) is an open-source CLI coding agent that supports multiple LLM providers. This guide shows you how to configure it to use KiosAPI.

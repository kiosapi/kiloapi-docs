---
title: Trae
description: Configure Trae AI code editor to use KiosAPI as the backend provider.
---

# Trae

[Trae](https://www.trae.ai/) is an AI-powered code editor by ByteDance. This guide shows you how to configure it to use KiosAPI instead of the default provider.
...
Once configured, you can use Trae's AI features (chat, inline completions, code generation) with KiosAPI as the backend.

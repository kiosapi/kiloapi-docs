---
title: Gemini CLI
description: Set up Google's Gemini CLI to use KiosAPI as the backend provider.
---

# Gemini CLI

[Gemini CLI](https://github.com/google-gemini/gemini-cli) is Google's official command-line interface for interacting with Gemini models. This guide shows you how to configure it to use KiosAPI.

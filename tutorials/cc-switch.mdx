---
title: CC Switch
description: Configure CC Switch to use KiosAPI as the backend provider for Claude Code.
---

# CC Switch

[CC Switch](https://github.com/farion1231/cc-switch) is a tool for switching between different API providers for Claude Code. This guide shows you how to configure it to use KiosAPI.
...
After switching to KiosAPI, test the configuration:
